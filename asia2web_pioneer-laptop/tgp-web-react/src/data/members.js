// src/data/members.js
// To add a photo: set photo to the image path e.g. '/images/members/01_cleck_pontillas.jpg'
...
export function getMemberTier(role) {
  const r = role.toLowerCase()
  if (r.includes('former')) return 'former'
